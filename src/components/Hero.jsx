...
const ImageList = [
    {
        ...
        description:
        "All varieties of Women's Products are available at an affordable price  "
    },
    {
        id: 2,
        img: Image2,
        ...
        description:
        "All varieties of Men's Products are available at an affordable price "
    },
    {
        id: 3,
        img: Image3,
        ...
        description:
        "All varieties of Products are available at an affordable price "
    },
]
                 ...
                 <div>
                    <div className="grid grid-cols-1 sm:grid-cols-2">
                        ...
                        <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10 ">
                            <h1 data-aos="zoom-out" data-aos-duration="500" data-aos-once="true" className="text-4xl sm:text-5xl lg:text-6xl font-bold">{data.tittle}</h1>
                            ...
                            <div  className="order-1 sm:order-2">
                                <div data-aos="zoom-in" data-aos-once="true" className="relative z-10">
                                    <img src={data.img} alt="" className="w-[300px] h-[300px] sm:h-[450px] sm:w-[450px] sm:scale-105 lg:scale-110 object-contain mx-auto" />
                    </div>
                </div>
            </div>
        </div>
