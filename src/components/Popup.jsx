        ...
        <div className="popup">
                ...
                <div className="fixed top-1/2 left-1/2 -translate-y-1/2 p-4 shadow-md bg-white dark:bg-gray-900 rounded-md duration-200 w-[300px]">
                    ...
                    <div className="mt-4">
                        ...
                        <button className="bg-gradient-to-r from-primary to-secondary transition-all duration-200 text-white py-1 px-4 rounded-full flex items-center gap-3 group hover:scale-105 ">
                        Order Now
                         </button>
                        </div>
                    </div>
