      ...
      <div className="container">
        <div data-aos="zoom-in" className="grid md:grid-cols-3 pb-44 pt-5">
            ...
            <div className="py-8 px-4">
                <h1 className="sm:text-3xl text-xl font-bold sm:text-left text-justify mb-3 flex items-center gap-3">
                    <img className="max-w-[50px]" src={footerLogo} alt="" />
                     Shopsy</h1>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, quo cum? any other solution for this page than give me All review ok</p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 col-span-2 md:pl-10">
                <div>
                    <div className="py-8 px-4">
                        <h2 className="sm:text-2xl text-xl font-bold sm:text-left text-justify mb-3">Important Links</h2>
